// ======================================================================
// ANCS Demo.v generated from TopDesign.cysch
// 12/05/2017 at 19:59
...
module BLE_v1_20_0 (
	...
	cy_clock_v1_0
		#(.id("53ee3da5-d255-4c20-811e-beb8f48e30d8/5ae6fa4d-f41a-4a35-8821-7ce70389cb0c"),
...
module top ;
	...
	wire [0:0] tmpOE__WakeupPin_net;
	wire [0:0] tmpFB_0__WakeupPin_net;
	wire [0:0] tmpIO_0__WakeupPin_net;
	electrical [0:0] tmpSIOVREF__WakeupPin_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		WakeupPin
		 (.oe(tmpOE__WakeupPin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__WakeupPin_net[0:0]}),
		  .io({tmpIO_0__WakeupPin_net[0:0]}),
		  .siovref(tmpSIOVREF__WakeupPin_net),
		  .interrupt({Net_18}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__WakeupPin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
